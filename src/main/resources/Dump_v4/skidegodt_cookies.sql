...
CREATE TABLE `cookies` (
  ...
  `cookie_value` varchar(50) NOT NULL,
  `datetime` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`cookie_id`),
  UNIQUE KEY `cookie_id_UNIQUE` (`cookie_id`),
  UNIQUE KEY `cookie_value_UNIQUE` (`cookie_value`),
  KEY `user_id_idx` (`user_id`),
  CONSTRAINT `user_id8` FOREIGN KEY (`user_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE
...
INSERT INTO `cookies` VALUES (23,3,'jlNSxM2jnh','2020-12-07 10:38:15');
...
-- Dump completed on 2020-12-07 10:57:30
