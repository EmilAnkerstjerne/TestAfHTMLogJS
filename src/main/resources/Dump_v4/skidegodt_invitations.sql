...
CREATE TABLE `invitations` (
  ...
  UNIQUE KEY `invitation_id_UNIQUE` (`invitation_id`),
  KEY `project_id_idx` (`project_id`),
  KEY `user_id_idx` (`user_id`),
  CONSTRAINT `project_id2` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`) ON DELETE CASCADE,
...
INSERT INTO `invitations` VALUES (1,1,4),(2,1,5);
